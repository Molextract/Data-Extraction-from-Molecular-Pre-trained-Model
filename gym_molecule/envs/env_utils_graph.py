...
# FRAG_VOCAB = open('gym_molecule/dataset/side_chain_bank.txt','r').readlines() # n=91
...
FRAG_VOCAB_MOL_WO_ATT = [Chem.DeleteSubstructs(mol, Chem.MolFromSmiles("*"))  for mol in FRAG_VOCAB_MOL]
